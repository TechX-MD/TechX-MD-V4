...
app.get('/', (req, res) => {
    ...
    <head>
        ...
        <title>TechX-MD V4 | Cyber Hacker Panel</title>
        ...
        <style>
            * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Courier New', Courier, monospace; }
            ...
            .stats-grid { width: 100%; display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 20px; }
            .stat-card { background: rgba(12, 2, 2, 0.85); border: 1px solid rgba(255, 0, 60, 0.3); border-radius: 8px; padding: 12px; display: flex; align-items: center; gap: 10px; }
            .stat-icon { width: 36px; height: 36px; background: rgba(255, 0, 60, 0.12); border-radius: 6px; display: flex; justify-content: center; align-items: center; color: #ff003c; font-size: 16px; border: 1px solid rgba(255, 0, 60, 0.3); }
            ...
            .steps { text-align: left; margin-top: 15px; border-top: 1px border rgba(255,255,255,0.1); padding-top: 15px; }
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div><div class="stat-val">${sessionCount}</div><div class="stat-label">Sessions</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon"><i class="fa-solid fa-circle-check"></i></div>
                    <div><div class="stat-val">${sessionCount > 0 ? sessionCount : 1}</div><div class="stat-label">Status Online</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon"><i class="fa-solid fa-microchip"></i></div>
                    <div><div class="stat-val">${getUptime()}</div><div class="stat-label">Uptime</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon"><i class="fa-solid fa-memory"></i></div>
                    <div><div class="stat-val">${memoryMB} MB</div><div class="stat-label">RAM Usage</div></div>
                </div>
            </div>
        ...
        <script>
            ...
            function updateCountryCode() { document.getElementById('phone').value = ''; }
    ...
    sock.ev.on('messages.upsert', async (m) => {
        try {
            ...
            if (command === 'ping') {
                ...
                const end = Date.now();
                await sock.sendMessage(from, { text: `🚀 *Response Speed:* ${end - start}ms` }, { quoted: msg });
            }
...
*Powered by TechX-MD V4 Engine*
                ...
                await sock.sendMessage(from, {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            ...
                            newsletterName: 'TechX-MD V4 Official',
                            serverMessageId: 1
                        },
                        externalAdReply: {
                ...
                await sock.sendMessage(from, { text: '✅ *TechX-MD V4 is Online & Ready to Serve!*' }, { quoted: msg });
            }
